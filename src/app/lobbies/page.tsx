...
export default function Lobbies() {
  console.log('Lobbies component rendering');
  const { lobbies, loading, error } = useLobbies();
  console.log('useLobbies result:', { lobbies, loading, error });

  const { openLobbies, inProgress } = useMemo(() => {
    console.log('Processing lobbies:', lobbies);
    ...
    console.log('Processed lobbies:', { open, progress });
