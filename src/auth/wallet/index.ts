...
export const walletAuth = async () => {
  ...
  const finalPayloadJson = JSON.stringify(result.finalPayload);
  console.log('Calling signIn with:', { nonce, signedNonce, finalPayloadJson: finalPayloadJson.substring(0, 100) + '...' });
